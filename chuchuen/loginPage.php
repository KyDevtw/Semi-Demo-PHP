            ...
            <form name="myForm" method="post" action="./login.php">
              <div class="row">
                <div class="col-lg-6 form-group">
                  ...
                  <input class="form-control form-control-lg" name="userMail" id="firstName" type="text" placeholder="請輸入帳號">
                </div>
                <div class="col-lg-6 form-group">
                  <label class="text-small text-uppercase" for="lastName">密碼</label>
                  <input class="form-control form-control-lg" name="userPwd" id="lastName" type="password" placeholder="請輸入密碼">
                </div>
                <div class="col-lg-12 form-group">
                  <input class="btn btn-dark" type="submit" value="登入">
                </div>
                <div class="col-lg-12 form-group">
                <p>還不是會員嗎？<a href="userRegister.php">立即註冊</a>  </p>
                </div>
              </div>
            </form>
          </div>
